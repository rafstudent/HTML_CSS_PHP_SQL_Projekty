...
<!-- Formularz edycji daty zakończenia projektu -->
<form method = "POST" action="aktualizuj_2.php">
...
<font size=5 name="Arial" color="white">Podaj nową datę zakończenia:</font><input type="date" value="0" name="data_zakonczenia" size=10% /> <br />
